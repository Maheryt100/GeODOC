        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                <div className={"w-1/4 flex items-center gap-4"}>
                    <Label><strong>Dossier:</strong>  {dossier.nom_dossier} </Label>
                    <Sheet>
                        ...
                        <SheetContent>
                            ...
                            <div className="grid flex-1 auto-rows-min gap-6 px-4">
                                <div className="grid gap-3">
                                    ...
                                    <Input value={dossier.nom_dossier} />
                                </div>
                                <div className="grid gap-3">
                                    <Label>Circonscription</Label>
                                    <Input value={dossier.circonscription} />
                                </div>
                                <div className="grid gap-3">
                                    <Label>Commune / fokontany</Label>
                                    <Input value={dossier.commune + " / " + dossier.fokontany } />
                                </div>
                                <div className="grid gap-3">
                                    <Label>type</Label>
                                    <Input value={dossier.type} />
                                </div>
                                <div className="grid gap-3">
                                    <Label>Date descente: {dossier.date_descente_debut} au {dossier.date_descente_fin}</Label>
                                </div>
                            </div>
                            <SheetFooter>
                                <SheetClose asChild>
                        ...
                        <div className={'mt-10'}>
                            ...
                            <div className={'flex flex-col md:flex-row gap-6 m-5'}>
                                <div className={'w-full md:w-1/4'}>
                                    ...
                                    <Input type={'number'} value={data.contenance}
                                           min={1}
                                           placeholder={'en m²'}
